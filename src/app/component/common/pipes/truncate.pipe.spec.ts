...
describe('TruncatePipe', () => {
  ...
  it('should truncate a string with spaces', () => {
    ...
    expect(pipe.transform(spaces, 30)).toEqual(
      'asdf asdf asdf asdf asdf asdf…'
    );
    expect(pipe.transform(spaces, 40)).toEqual(
  ...
  it('should truncate a string without spaces', () => {
    ...
    expect(pipe.transform(nospaces, 30)).toEqual(
      'abcdefghijklmnopqrstuvwxyzabcd…'
    );
    expect(pipe.transform(nospaces, 40)).toEqual(
